...
<div class="main__block">
    <div class="main__block__container">
        <div class="box"> 
            <img class="mob__logo" src="img/logo.png" alt=""> 
            <ul class="list">
                    ...
                    <div class="user__name__container">
                        ...
                        @else
                            <div class="menu__auth">
                                <li><a class="menu__auth__item" href="{{ route('user.register') }}" target="_blank">Реєстрація</a></li>
                                <li><a class="menu__auth__item" href="{{ route('user.login') }}" target="_blank">Війти</a></li>
                            </div>
                        @endif
                    </div>
                </div>
            </ul>
            <ul class="header__menu__icon">
                <li class="header__menu__icon__item"></li>
                <li class="header__menu__icon__item"></li>
                <li class="header__menu__icon__item"></li>
                <li class="header__menu__icon__item"></li>
                <li class="header__menu__icon__item"></li>
        ...
        <ul class="header__menu__mob">
                <li class="header__menu__mob__inner"><a class="header__menu__mob__item" href="#">Про нас</a></li>
                <li class="header__menu__mob__inner"><a class="header__menu__mob__item" href="#">Наша команда</a></li>
                <li class="header__menu__mob__inner"><a class="header__menu__mob__item" href="#">Контактна форма</a></li>
                <li class="header__menu__mob__inner"><a class="header__menu__mob__item" href="#">Реєстрація</a></li>
                <li class="header__menu__mob__inner"><a class="header__menu__mob__item" href="#">Війти</a></li>
            </ul>
        <div class="ttb">
    ...
    <div class="info__title">Наші послуги</div>
        <div class="container__img">
            <div class="container__img__inner">
                <img class="item__img" src="img/2/bigdata.jpg" alt="">
            ...
            <div class="container__img__inner">
                <img class="item__img" src="img/2/software.jpeg" alt="">
                <div class="block__text">
                    ...
                    <div class="item__text">Технології розширюють можливості тривалої співпраці
                        ...
                        канали надходження прибутків. 
                    </div>
                </div>
            </div>
            <div class="container__img__inner">
                <img class="item__img" src="img/2/design.jpg" alt="">
                <div class="block__text">
            ...
            <div class="container__img__inner">
                <img class="item__img" src="img/2/AI.jpg" alt="">
                <div class="block__text">
            ...
            <div class="container__img__inner">
                <img class="item__img" src="img/2/cloud.png" alt="">
                <div class="block__text">
            ...
            <div class="container__img__inner">
                <img class="item__img" src="img/2/cybersecurity.jpg" alt="">
                <div class="block__text">
            ...
            <div class="container__img__inner">
                <img class="item__img" src="img/2/vr.png" alt="">
                <div class="block__text">
            ...
            <div class="container__img__inner">
                <img class="item__img" src="img/2/robotics.jpg" alt="">
                <div class="block__text">
                    <div class="item__title eighth">Ротоботехніка</div>
                    <div class="item__text">FOR THE FUTURE з професійною точністю 
...
<footer>
    ...
    <!-- <div class="header">
        <a class="main__page__text" href="/private">Return to the private page</a>
        <div class="user__name">
            ...
            <div class="menu__auth">
                <a class="menu__auth__item" href="{{ route('user.register') }}">Register</a>
                <a class="menu__auth__item" href="{{ route('user.login') }}">Login</a>
            </div>
            @endif
            <div class="menu">
                <ul>
    ...
    @if(Auth::user())
        <script type="text/javascript">
            ...
            s1.async=true;
            s1.src='https://embed.tawk.to/629df994b0d10b6f3e75eece/1g4shdrej';
            s1.charset='UTF-8';
